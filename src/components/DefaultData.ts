import { IEducation, IPersonal, IProfession } from "src/app/types";
...
const defaultProfessions: IProfession[] = [
  {
    company: "Company Two",
    ...
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellendus et dolore repellat eos ea ratione doloribus sit iure ipsa omnis voluptate veniam, eius excepturi nihil, impedit aliquid, soluta illo nisi.",
    id: crypto.randomUUID(),
  },
  {
    company: "Company One",
    ...
    location: "Some City, Country",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum dolores, nam rem placeat dolore minima quis dolorem distinctio maiores officia ipsum vel, inventore voluptate sunt facilis expedita nisi qui deleniti.",
    id: crypto.randomUUID(),
  },
];
